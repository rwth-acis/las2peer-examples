...
public class ServiceTest {
	...
	private static final ServiceNameVersion testExampleService = new ServiceNameVersion(ExampleService.class.getCanonicalName(),"1.0");
	...
	/**
	 * Test the ExampleService for valid rest mapping.
	 * Important for development.
	 */
	@Test
	public void testDebugMapping()
	{
		ExampleService cl = new ExampleService();
